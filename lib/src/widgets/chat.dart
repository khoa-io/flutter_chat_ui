...
class Chat extends StatefulWidget {
  ...
  const Chat({
    ...
    this.showingOptions = const ShowingOption(
      showUserAvatars: false,
      showUserNames: false,
      showCaptionUnderTextMessage: false,
    ),
  ...
  final ShowingOption showingOptions;
  ...
  /// See [Message.textMessageCaptionFormatter].
  final String Function(types.Message)? textMessageCaptionFormatter;
  ...
  Widget _messageBuilder(
    ...
    if (object is DateHeader) {
      ...
      if (message is types.SystemMessage) {
        ...
        final messageWidth =
            widget.showingOptions.showUserAvatars && message.author.id != widget.user.id ? min(constraints.maxWidth * 0.72, 440).floor() : min(constraints.maxWidth * 0.78, 440).floor();
        ...
        messageWidget = Message(
          ...
          showUserAvatars: widget.showingOptions.showUserAvatars,
          textMessageBuilder: widget.textMessageBuilder,
          textMessageOptions: widget.textMessageOptions,
          usePreviewData: widget.usePreviewData,
          userAgent: widget.userAgent,
          videoMessageBuilder: widget.videoMessageBuilder,
          textMessageCaptionFormatter: widget.textMessageCaptionFormatter,
        );
      }
  ...
  void didUpdateWidget(covariant Chat oldWidget) {
    ...
    if (widget.messages.isNotEmpty) {
      final result = calculateChatMessages(
        ...
        showUserNames: widget.showingOptions.showUserNames,
